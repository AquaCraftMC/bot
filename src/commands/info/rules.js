...
module.exports = {
    ...
    execute: async function(client, message, args) {
      ...
      .setDescription(`Check out the <#835277943151394897> channel to view the rules,\nor run \`${PREFIX}rules (# / all)\` to see a specific rule!`)
      ...
      .setDescription(`The \`all\` subcommand can only be used in the <#835277943151394897> channel.\nCheck out the rules channel, or run \`${PREFIX}rules (Rule Number)\``)
      .setColor(EMBED_COLOR)
      .setTimestamp()
      .setFooter(`${message.author.tag}`, `${message.author.displayAvatarURL()}`)
      ...
      if (!args.length) {
        ...
        if (message.channel.id !== '835277943151394897') {
          message.delete()
          message.channel.send(notHereEmbed)
            ...
            .catch(console.error);
        } else if (message.channel.id == '835277943151394897') {
          message.delete()
